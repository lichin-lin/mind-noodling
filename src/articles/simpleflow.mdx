...
There was a `createConnector()` api, but only for Figjam, not Figma design. I tried a few experiments, but couldn’t make them feel native. Eventually i paused the project.
...
```html title="index.html" lines={[3,4]} showLineNumbers
<meta charset="utf-8" />
  <div>
