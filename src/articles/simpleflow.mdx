...
import clipboardImage from "../assets/simpleflow/clipboard.png";
...
<img src="{clipboardImage}" alt="Clipboard Inspector" />
...
That fig-kiwi string turned out to be Figma’s internal Kiwi forma (created by co-founder & former CTO Evan Wallace) the same schema used to encode `.fig` files. So what I needed to store wasn’t just vector data; it was a tiny .fig file encoded into the clipboard’s HTML.
